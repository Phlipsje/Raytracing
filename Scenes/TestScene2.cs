    ...
    public class TestScene2 : IScene
    {
        ...
        public TestScene2()
        {
            ...
            Primitives = new List<IPrimitive>
            {
                ...
                new Sphere(new Vector3(-1.5f, 0.5f, 0), 0.5f, new Material(Color4.Red, new Color4(0.3f, 0.3f, 0.3f, 1f), false, 3f)),
                new Sphere(new Vector3(1.5f, 0.5f, 0), 0.5f, new Material(Color4.Red, new Color4(1f, 0f, 0f, 1f), false, 5f)),
