...
namespace INFOGR2024Template.Scenes
{
    public class TestScene1 : IScene
    {
        ...
        public TestScene1()
        {
            ...
            Primitives = Primitives.Concat(OBJImportHelper.ImportModel(OBJImportHelper.FilePath("pyramid"), 0.03f, new Vector3(1, 0, 0), new Material(Color4.Black, new Color4(0, 0, 255, 255), true, 1f))).ToList();
