...
public interface IPrimitive
{
    ...
    public Tuple<float, Material> RayIntersect(Ray ray, out Vector3 normal); //If a ray hits this primitive (return scalar of ray direction (negative means not hit))
